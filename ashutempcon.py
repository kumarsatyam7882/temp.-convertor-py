...
Entry(f1, textvariable=var1, font="Lucida 20", fg="cyan", justify='center').pack(side=LEFT, padx=90)
Entry(f1, textvariable=var2, font="Lucida 20", fg="cyan", justify='center').pack(side=LEFT, padx=90)
